...
public class AddApiController {
	...
	public static final String serviceName = ServiceConstants.ADD_API_SERVICE;
	public static final String restUrlAddress = ServiceConstants.BASE_REST_URL + serviceName;

	@Operation(summary = "tambah baru hak akses API", description = " API untuk tambah baru hak akses ", security = {
	...
	public ResponseEntity<?> controller(@Valid @RequestBody AddApiReqEntity serviceInput) {
