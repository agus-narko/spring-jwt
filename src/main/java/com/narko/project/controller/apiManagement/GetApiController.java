...
public class GetApiController {
	...
	public static final String serviceName = ServiceConstants.GET_API_SERVICE;
	public static final String restUrlAddress = ServiceConstants.BASE_REST_URL + serviceName;

	@Operation(summary = "get list hak akses API", description = " API untuk get data hak akses ", security = {
