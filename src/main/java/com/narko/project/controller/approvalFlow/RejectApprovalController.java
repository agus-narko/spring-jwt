...
public class RejectApprovalController {

	@Autowired
	BoInterceptor commandProcessingService;

	public static final String serviceName = ServiceConstants.REJECT_APPROVAL_SERVICE;
	public static final String restUrlAddress = ServiceConstants.BASE_REST_URL + serviceName;

	@Operation(summary = "reject request approval", description = " API untuk menolak pengajuan data ", security = {
	...
	public ResponseEntity<?> controller(@Valid @RequestBody RejectApprovalReqEntity serviceInput) {
