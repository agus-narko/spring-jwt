...
public class AddRoleController {
	...
	public static final String serviceName = ServiceConstants.ADD_ROLE_SERVICE;
	public static final String restUrlAddress = ServiceConstants.BASE_REST_URL + serviceName;
	

	@Operation(summary = "add role API", description = " API untuk tambah data role ", security = {
 ...
 // di pakai jika service mempunyai hak akses,jika permit all dicomment saja
	public ResponseEntity<?> controller(@Valid @RequestBody AddRoleReqEntity serviceInput) {
