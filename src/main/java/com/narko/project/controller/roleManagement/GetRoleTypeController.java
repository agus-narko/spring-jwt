...
public class GetRoleTypeController {
	...
	public static final String serviceName = ServiceConstants.GET_ROLE_TYPE_SERVICE;
	public static final String restUrlAddress = ServiceConstants.BASE_REST_URL + serviceName;

	@Operation(summary = "get role type API", description = " API untuk get data role type ", security = {
