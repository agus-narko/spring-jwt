...
public class ActivationUserController {
	...
	public static final String serviceName = ServiceConstants.ACTIVATION_USER_SERVICE;
	public static final String restUrlAddress = ServiceConstants.BASE_REST_URL + serviceName;

	@Operation(summary = "activation user API", description = " API untuk activation user ", security = {
